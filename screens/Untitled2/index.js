...
const Untitled2 = ({
  ...
  return <View style={_styles.abGCwBJe}>
      <ImageBackground style={_styles.QBgKAAgv} source={{
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.JemojZkY}>Second Screen</Text><Pressable onPress={() => navigation.navigate("aboutTheApp")} style={_styles.LkqPqIsa}><View style={_styles.EdNUNQgJ}></View></Pressable></View>;
};
